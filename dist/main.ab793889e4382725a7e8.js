...
console.log(moment().startOf("day").fromNow()); // Tester html-webpack-plugin : js -> html
...
p.textContent = "VPS à usage de formation sur le projet Camino de la Fabrique Numérique";
var app = document.querySelector("#root");
app.append(h1);
app.append(h2);
app.append(p); // Tester du code ancien
// créer une instance de classe sans constructeur

var StartUp = function StartUp() {
  _classCallCheck(this, StartUp);

  _defineProperty(this, "name", "camino");
};

var myStartUp = new StartUp();
var p2 = document.createElement("p");
p2.textContent = "".concat(myStartUp.name, " est top !");
app.append(p2);
})();

/******/ })()
;
//# sourceMappingURL=main.ab793889e4382725a7e8.js.map